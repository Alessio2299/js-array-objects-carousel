...
for (let i = 0; i < items.length; i++) {
    item += `
        <div class="item">
            <img src="${items[i]["photo"]}" alt="Immagine ${items[i]["title"]}">
            <div class="text">
                <h3>${items[i]["title"]}</h3>
                <p>${items[i]["text"]}</p>
            </div>
    ...
    thumb += `
        <div class="thumb">
            <img src="${items[i]["photo"]}" alt="Thumb ${items[i]["title"]}">
        </div>
    `
}
// Seconda Solizione
...
for (let i = 0; i < items.length; i++) {
    ...
    item += `
        <div class="item">
            <img src="${currentItem.photo}" alt="Immagine ${currentItem ["title"]}">
            <div class="text">
    ...
    thumb += `
        <div class="thumb">
            <img src="${currentItem["photo"]}" alt="Thumb ${currentItem ["title"]}">
        </div>
    `
}
*/
